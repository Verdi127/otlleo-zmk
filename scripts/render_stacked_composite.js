 ...
 * - Loads SVG artifacts produced earlier in the workflow:
 *   1) stacked.svg
 *   2) legend.svg (optional)
 *   3) combos.svg (optional)
 ...
 * - KEYMAP_COMBOS               : include/exclude combos block
...
const combosOn = (process.env.KEYMAP_COMBOS || '1') !== '0';
...
const legendBlock = legendOn
  ...
  : '';
const combosBlock = combosSrc
  ? '<div class="block"><img id="combos-svg" src="__COMBOS_SRC__" alt="combos keymap" /></div>'
  : '';
...
html = html.replace('__COMBOS_BLOCK__', combosBlock);
